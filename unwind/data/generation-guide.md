...
- **`recurring_motifs`** — available symbolic vocabulary. These images can anchor any section — essay, fragment, now_here, word — without forcing. They are not required in every digest, but they are always available as natural territory. Prefer them when the essay's subject touches them organically.
